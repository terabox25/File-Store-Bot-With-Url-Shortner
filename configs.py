...
class Config(object):
  ...
  BOT_TOKEN = os.environ.get("BOT_TOKEN", "7105638751:AAH6YLfeGu14DJ98OeX6ucTogig4esdqRCk")
  BOT_USERNAME = os.environ.get("BOT_USERNAME", "lkd_share_bot")
  DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "1001911273978"))
  SHORTLINK_URL = os.environ.get('SHORTLINK_URL', "")
  SHORTLINK_API = os.environ.get('SHORTLINK_API', "")
  BOT_OWNER = int(os.environ.get("BOT_OWNER", "5018200809"))
  DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://terabox255iih4zq4It0iU17h8@cluster0.zz9jddh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
